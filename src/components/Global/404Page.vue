  ...
  <div class="container">
    <div class="left-section">
      <div class="inner-content">
        ...
        <p class="subheading">Sorry the we've changed up the site, anything that was there before should still be there!</p>
        <router-link style="text-decoration: none" to="/">
        <a class="btn btn-sm animated-button thar-two submit">Home Page</a>
        </router-link>
      </div>
    </div>
...
<style scoped>
  ...
  * {
  ...
  .svgimg .lamp-bottom {
    background: linear-gradient(#202425, #0C0E10);
  }
  .svgimg .lamp-light {
    fill: #EFEFEF;
  }
