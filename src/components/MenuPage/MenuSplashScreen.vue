<template>
  <div id="Capsule">
    <div id="CenterWindow">
      ...
      <div id="SplashPage">
        <div id="MainTitle">
          <div id="ShopTitle">  Menu </div>
          <div id="Line"></div>
          <div id="SubTitle"> Locally sourced and ethically produced </div>
        </div>
      </div>
    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ServiceClick() {
                $('html, body').animate({
                    scrollTop: $("#MainWindow").offset().top -400
                }, 2000);
            }
        }
    }
...
<style scoped>
  ...
  #SplashPage {
    grid-area: Main;
    background-image: url("../../assets/images/FishnChipMenu.webp");
