<template>
  <div id="Page">
    ...
    <div id="Terms">
      <div id="ContactTitle"> Payment Methods </div>
      <pre class="Desc">
        BANK ACCOUNT - Be Paid Ltd  02 – 0916 – 0123748 – 00
        Please include your reference number and/or your last name so we know it belongs to you.
